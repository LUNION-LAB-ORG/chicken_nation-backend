...
export const TURBO_API = {
    ...
    LISTE_FRAIS: 'https://backend-prod.turbodeliveryapp.com/api/erp/frais-livraison/restaurant/listeFrais', // récupération de la liste des frais de livraison d'un restaurant
}
